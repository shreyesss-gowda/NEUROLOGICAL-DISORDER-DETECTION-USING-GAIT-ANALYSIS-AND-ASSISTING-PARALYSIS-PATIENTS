...
class VirtualKeyboard:
    ...
    def __init__(self, master=Tk()):
        ...
        bottom_position = self.user_scr_height - 50 - self.size_value_map[self.size_current][1]

        # Set the geometry of the window with the bottom position
        self.master.geometry(f"{self.size_value_map[self.size_current][0]}x{self.size_value_map[self.size_current][1]}+0+{bottom_position}")
